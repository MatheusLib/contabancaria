...
public class Menu {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * // Teste da Classe Conta Corrente ContaCorrente cc1 = new ContaCorrente(124,
		 * 003, 1, "Fatmia J.", 0.0f, 1000.0f); cc1.visualizar(); cc1.sacar(12000.0f);
		 * cc1.visualizar(); cc1.depositar(5000.0f); cc1.visualizar();
		 * 
		 * // Teste da Classe Conta Poupança ContaPoupanca cp1 = new ContaPoupanca(125,
		 * 003, 2, "Valmir Q.", 100000.0f, 15); cp1.visualizar(); cp1.sacar(1000.0f);
